...
namespace DAL
{
    ...
    public class BuildSql
    {
        ...
        #region 执行单个插入操作 + public static int Add(string table, object obj)
        /// <summary>
        /// 执行插入操作 
        /// </summary>
        ...
        #region 执行更新修改操作 + public int UpdateWithModify(string table, object obj)
        /// <summary>
        /// 执行更新修改操作 
        /// </summary>
        ...
        #region 根据ID返回实体对象 + public static object GetModelById(string table, string id, object obj)
        /// <summary>
        /// 根据ID返回实体对象
        /// </summary>
        /// <param name="table">数据表</param>
        ...
        #region 根据指定条件（指定列或值）返回实体对象 +   public static object GetModelByWhere(string table, object obj, string sqlName, string value)
        /// <summary>
        ///  根据指定条件（指定列或值）返回实体对象
        /// </summary>
        /// <param name="table">数据表</param>
        ...
        #region 返回泛型集合对象 +  public static List<object> GetListByWhere(string table, object obj, string desc = "desc", string sqlWhere = "")
        /// <summary>
        /// 返回泛型集合对象
        /// </summary>
        /// <param name="table">数据表</param>
        ...
        #region 简单分页返回泛型集合数据+   public static List<object> SimplePager(string table, object obj, string paseSize, string currentPage, string sqlWhere = "")
        /// <summary>
        /// 简单分页返回泛型集合数据
        /// </summary>
        /// <param name="table">数据表</param>
        ...
        public static List<object> SimplePager(string table, object obj, string paseSize, string currentPage, string sqlWhere = "")
        {
            string columnParas = string.Empty;
            string columnNames = BuildSql.GetSqlColumnAndSqlParams(table, out columnParas, true);
